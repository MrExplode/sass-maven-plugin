...
public abstract class AbstractSassMojo extends AbstractMojo {
     ...
     *
     * @parameter property="buildDirectory" default-value="${project.build.directory}"
     */
     ...
     * </pre>
     * @see <a href="http://sass-lang.com/docs/yardoc/file.SASS_REFERENCE.html#options">sass-lang.com</a>
     * @parameter
     */
    protected Map<String, String> sassOptions = new HashMap<>(Map.of(
            "unix_newlines", "true",
            "cache", "true",
            "always_update", "true",
            "style", ":expanded"));
    ...
    protected void buildBasicSASSScript(final StringBuilder sassScript) throws MojoExecutionException {
        ...
        final Iterator<Map.Entry<String, String>> templateLocations = getTemplateLocations();
    ...
    private Iterator<Map.Entry<String, String>> getTemplateLocations() {
        ...
        for (final Resource source : r) {
            for (final Map.Entry<String, String> entry : source.getDirectoriesAndDestinations().entrySet()) {
